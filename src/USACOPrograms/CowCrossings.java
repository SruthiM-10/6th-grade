...
public class CowCrossings {
    public static void main(String[] args) {
        ...
        int n = scan.nextInt(), cowNumber , location, count = 0;
        int[] sideOfRoad = {2,2,2,2,2,2,2,2,2,2};
        for(int i = 0; i < n; i ++){
            cowNumber = scan.nextInt();
            location = scan.nextInt();
            if (sideOfRoad[cowNumber - 1] != location && sideOfRoad[cowNumber - 1] != 2)
                count ++;
            sideOfRoad[cowNumber-1] = location;
        }
